...
def operation(request, number1, number2):
    ...
    return render(request, "practices/operation.html", context)


# 3번
def random_past(request):

    return render(request, "practices/random_past.html")
...
def random_past2(request):
    ...
    return render(request, "practices/random_past2.html", context)
...
def lorem2(request):
    ...
    return render(request, "practices/lorem2.html", context)
